...
At this point, we end our historical overview. Some of the more recent approaches and debates will be discussed in \autoref{sec:natural}, \autoref{sec:more}, and \autoref{sec:objections}.
